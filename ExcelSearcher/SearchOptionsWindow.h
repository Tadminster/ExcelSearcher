...
struct FSearchOptions
{
    ...
    bool bUseCustomMeta  = false;    // 커스텀 필터 사용
...
private:
    void WriteLine(std::ofstream& ofs, const std::string& k, const std::string& v);
    void WriteBool(std::ofstream& ofs, const char* k, bool v);
