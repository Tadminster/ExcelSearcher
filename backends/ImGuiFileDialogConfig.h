...
#define returnDirButtonString ICON_FA_ROTATE_RIGHT //"↩"
 #define resetButtonString ICON_FA_ERASER //"R"
// #define devicesButtonString "Devices"
 #define editPathButtonString ICON_FA_PEN//"E"
 #define searchString ICON_FA_MAGNIFYING_GLASS "  검색"
 #define dirEntryString  ICON_FA_FOLDER " "//"[DIR] "
// #define linkEntryString "[LINK] "
 #define fileEntryString ICON_FA_FILE " " //"[FILE] "
// #define fileNameString "File Name : "
// #define dirNameString "Directory Path :"
 #define buttonResetSearchString u8"검색어 초기화\n입력된 검색어를 초기화하려면 이 버튼을 누르세요."
// #define buttonDriveString "Devices"
 #define buttonEditPathString u8"경로 편집\n이 버튼을 누르거나, 경로를 우클릭하여 경로를 직접 입력할 수 있어요."
 #define buttonResetPathString u8"되돌아가기\n기본 경로로 돌아가려면 이 버튼을 누르세요."
 #define buttonCreateDirString u8"새 폴더 생성\n이 버튼을 눌러 현재 경로에 새 폴더를 생성할 수 있어요."
...
/////////////////////////////////
 ...
 #define placesButtonString u8"탐색 창"
 #define placesButtonHelpString u8"컴퓨터 안의 폴더 구조를 눈으로 보고, 이동하려면 이곳을 누르세요."
...
//////////////////////////////////////
 ...
 #define placesBookmarksGroupName ICON_FA_STAR u8"  즐겨찾기"
